...
mkdir -p "/task/Практическое задание" && mv /task/dir1/summary.txt "/task/Практическое задание/Практическое задание.txt"
# выводим на консоль содержимое файла task/Практическое задание
cat "/task/Практическое задание/Практическое задание.txt"
# ищем в файле "Практическое задание" строки, которые содержат слово "dir"
# и затем отсортировываем их
grep "dir" /task/'Практическое задание'/'Практическое задание.txt' | sort
